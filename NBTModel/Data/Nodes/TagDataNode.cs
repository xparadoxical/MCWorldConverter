...
namespace NBTExplorer.Model
{
    public abstract class TagDataNode : DataNode
    {
        ...
        static TagDataNode()
        {
            ...
            {
                [TagType.TAG_BYTE] = typeof(TagByteDataNode),
                [TagType.TAG_BYTE_ARRAY] = typeof(TagByteArrayDataNode),
                [TagType.TAG_COMPOUND] = typeof(TagCompoundDataNode),
                [TagType.TAG_DOUBLE] = typeof(TagDoubleDataNode),
                [TagType.TAG_FLOAT] = typeof(TagFloatDataNode),
                [TagType.TAG_INT] = typeof(TagIntDataNode),
                [TagType.TAG_INT_ARRAY] = typeof(TagIntArrayDataNode),
                [TagType.TAG_LIST] = typeof(TagListDataNode),
                [TagType.TAG_LONG] = typeof(TagLongDataNode),
                [TagType.TAG_LONG_ARRAY] = typeof(TagLongArrayDataNode),
                [TagType.TAG_SHORT] = typeof(TagShortDataNode),
                [TagType.TAG_SHORT_ARRAY] = typeof(TagShortArrayDataNode),
                [TagType.TAG_STRING] = typeof(TagStringDataNode)
            };
        }
